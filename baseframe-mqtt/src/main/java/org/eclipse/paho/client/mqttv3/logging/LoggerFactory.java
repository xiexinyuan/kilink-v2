 ...
 * logging facility java.utils.logging (JSR47).  It is possible to override
 ...
 * java.utils.logging.  For systems where this is not available or where
...
public class LoggerFactory {
	...
	/**
	 * Default logger that uses java.utils.logging.
	 */
	 ...
	 * that uses java.utils.logging will be returned.
	 * 
...
//		}
	...
	public static String getLoggingProperty(String name) {
		String result = null;
		try {
			// Hide behind reflection as java.utils.logging is guaranteed to be
			// available.
