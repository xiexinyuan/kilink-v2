    ...
    public void run() {
        ...
        while (running && (in != null)) {
            try {
                ...
                System.err.println(System.currentTimeMillis() + "==[MQTT MSG] (first) mqtt io shut down!!!");
                try {
                    Thread.sleep(500);
                } catch (InterruptedException e) {
                    e.printStackTrace();
                ...
                if (!clientComms.isDisconnecting()) {
                    System.err.println(System.currentTimeMillis() + "==[MQTT MSG] (second) mqtt io shut down!!!");
                    try {
                        Thread.sleep(500);
                    } catch (InterruptedException e) {
                        e.printStackTrace();
